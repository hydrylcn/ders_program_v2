...
# BU VERSİYONDA ÖZEL KISIT AYARLARINA ZORUNLU EXCLUDE EKLENDİ
...
# --- ESNEK AYARLAR ---
MAX_DAYS_PER_LECTURER = 3  # Bir hocanın haftada okula geleceği maksimum gün hedefi
MIN_SLOT_GAP = 2  # Bir hocanın iki dersi arasındaki zorunlu minimum blok boşluk (2 = 1 blok boş kalsın)
HOCA_GUN_CEZASI = 500  # Hoca 3 günden fazla gelirse skora eklenecek ceza puanı (Düşük skor daha iyidir)
TRIAL_TIMEOUT = 10  # Algoritmanın tek bir deneme (trial) için harcayacağı maksimum saniye (sıkışma koruması)

# --- ÖZEL KISIT AYARLARI ---
# type "ONLY": Ders SADECE belirtilen gün/saatlerde olabilir.
# type "NEVER": Ders belirtilen gün/saatlerde ASLA olamaz.
# Anahtar kelime başındaki "!" işareti: "İçinde bu kelime GEÇMEYENLER" (NOT) anlamına gelir.
SPECIAL_CONSTRAINTS = {
    "Tezsiz": {  # Sınıf adında "Tezsiz" geçen dersler için kural
        "type": "ONLY",
        "days": ["Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma"],
        "slots": ["19:00-21:00"]  # Sadece akşam saatlerine izin ver
    },
    "!Tezsiz": {  # Sınıf adında "Tezsiz" geçmeyen dersler için kural
        "type": "NEVER",
        "days": ["Pazartesi", "Salı", "Çarşamba", "Perşembe", "Cuma"],
        "slots": ["19:00-21:00"]  # Akşam saatlerini örgün eğitime yasakla
    }
}
...
def report_final(schedule, score):
    ...
    # Sınıf bazlı eşzamanlı dersleri raporla
    ...
    # Hoca bazlı gün yayılımını raporla
